...
if (isset($_POST['sign_up'])) {
    ...
    if (checkEmpty($first_name, $last_name, $email, $password)) {
        $_SESSION['err-empty-validation'] = "Please fill all the fields";
...
function checkExist($email)
{
    ...
    //var_dump($rst);
    $number_rows = mysqli_num_rows($rst); // return number of rows
...
function insertDB($first_name, $last_name, $email, $password)
{
    ...
    // err handling 
    if ($rst == false) {
        $_SESSION['inserting-err'] = "error while inserting ..";
